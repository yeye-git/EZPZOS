...
var DataObject = exports.DataObject = /*#__PURE__*/function (_Base) {
  //#endregion
  ...
  function DataObject() {
    ...
    _this = _callSuper(this, DataObject, [logLevel]);
  ...
  return _createClass(DataObject, [{
    ...
    value: function RemoveEvent(event) {
      var index = this._Events.map(function (event) {
        return event.Id;
      }).indexOf(event.Id, 0);
      if (index > -1) {
