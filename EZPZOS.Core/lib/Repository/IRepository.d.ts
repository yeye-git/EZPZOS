...
export interface IRepository {
     ...
     * @param callback Get the result of the insert operation
     */
    Save(dataobject: IDataObject, userId: string, isUpdate: boolean, isDelete: boolean, callback: (result: boolean) => void): void;
    /**
     ...
     * @param callback Get the result of the delete operation
     */
    OnSaving(dataObject: IDataObject, userId: string, isUpdate: boolean, isDelete: boolean, callback: (result: boolean) => void): void;
    /**
     ...
     * @param callback Get the result of the delete operation
     */
    OnSaved(dataObject: IDataObject, userId: string, isUpdate: boolean, isDelete: boolean, callback: (result: boolean) => void): void;
    /**
     ...
     * @returns void
     */
    Execute<T>(sqlQuery: string, dataObject: IDataObject | object, prepareParam: (preparedStatement: PreparedStatement) => PreparedStatement, callback: (err?: Error, recordset?: IProcedureResult<T>) => void): void;
}
